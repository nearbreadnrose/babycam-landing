        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-gradient-to-br from-green-50 to-mint-50 border-4 border-green-300 rounded-3xl p-10 shadow-xl">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              출시 전 <span className="font-semibold text-primary-600">우선 안내</span>드리겠습니다<br />
              조금만 기다려주세요
            </p>
          </div>
        </div>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            ...
            <span className="text-sm text-gray-500">많은 부모님들이 기다리고 계십니다</span>
          </p>
        </div>
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-8 shadow-xl border-2 border-primary-100">
          <div className="space-y-5 mb-8">
            ...
            <div>
              <label htmlFor="babycamType" className="block text-sm font-semibold text-gray-700 mb-3">
                <span>베이비캠 종류</span>
                <span className="text-primary-600">*</span>
              </label>
              <input
            ...
            <div>
              <label htmlFor="inquiry" className="block text-sm font-semibold text-gray-700 mb-3">
                <span>문의사항</span>
                <span className="text-gray-400 text-xs">(선택사항)</span>
              </label>
              <textarea
          ...
          <div className="mt-6 text-center">
            ...
            <p className="text-xs text-gray-500">
              개인정보는 안전하게 보관되며, 서비스 안내 목적으로만 사용됩니다
            </p>
          </div>
        </form>
